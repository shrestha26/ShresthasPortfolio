  ...
  const projects = [
    {
      ...
      period: "2023-2024",
      description:
        "Advanced multilingual intelligence decryption system designed for national defense applications.",
      longDescription:
        "Designed and developed a sophisticated multimedia translator to decrypt multilingual terrorist intelligence for the Indian Army. The system integrates AI-powered translation with secure communication protocols.",
      features: [
      ...
      liveUrl: "https://multimedia-translator.vercel.app/",
      icon: Shield,
    ...
    },
    {
      ...
      period: "2023",
      description:
        "Specialized calculator for aerospace calculations and orbital mechanics computations.",
      longDescription:
        "Developed a space-scientific calculator tailored for ISRO scientists to assist in orbital mechanics and mission planning with advanced aerospace metrics computation.",
      features: [
      ...
      liveUrl: "https://space-scientific-calculator.vercel.app/",
      icon: Code,
    ...
    },
    {
      ...
      period: "2025",
      description:
        "Full-featured ATM simulation with security testing capabilities and vulnerability assessment.",
      longDescription:
        "Comprehensive web-based ATM simulation system that replicates core banking operations with integrated security testing for penetration testing practice.",
      features: [
    ...
    },
    {
      ...
      period: "2025",
      description:
        "Production-ready stock prediction application with multiple ML algorithms and real-time analysis.",
      longDescription:
        "Built a comprehensive stock prediction web application featuring interactive ML model selection, real-time predictions, and professional financial dashboard.",
      features: [
      ...
      liveUrl: "https://machine-learning-stock-prediction.vercel.app",
      icon: TrendingUp,
          ...
          <div className="grid gap-10">
            {projects.map((project, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-gray-800/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 hover:shadow-xl hover:scale-[1.01]"
                >
