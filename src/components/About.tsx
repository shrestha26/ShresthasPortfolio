      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-12 leading-relaxed">
            ...
            I’ve been fortunate to gain hands-on experience at esteemed organizations like DRDO and JPMorgan Chase & Co. , where I learned to build secure, scalable systems and contribute to meaningful projects. 
