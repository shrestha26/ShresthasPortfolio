  ...
  const projects = [
    {
      ...
      image: '/multimedia-translator.png', // ADD YOUR IMAGE
    },
    {
      ...
      image: '/images/space-calculator.png',
    },
    {
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  {project.image && (
                    <img
                      src={project.image}
                      alt={project.title}
                      className="w-full md:w-64 lg:w-72 h-48 object-cover rounded-lg shadow-lg"
                    />
                  )}
                </div>
              </div>
